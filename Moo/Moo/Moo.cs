    ...
    class Moo
    {
        ...
        static void Help()
        {
            string help = "За да научите повече за правилата на играта, моля въведете \"rules\". \n\n" +
                "Ако се затруднявате с разкриването на числото конфигурирано от компютъра, може да ползвате жокер, като въведете \"joker\". \n\n" +
                "Ако наистина много се затруднявате с разкриването на числото, въведете \"surrender\" и търсеното число ще се изпише. \n\n" +
                "Ако екрана ви се струва препълнен, може да използвате командата \"clear\", която ще изчисти вашите предположения и всички съобщения от компютъра.\n"+
                "След като изчистите екрана може да използвате командата \"log\", за да получите списък с досегашните ви предположения и резултатът от тях.\n\n"+
                "За изход от играта въведете \"exit\".\n\n" +
                "Примерна стратегия: Aко се играе например с 4-цифрено число може да се започне с първи опит: 1234 и втори опит: 5678.";
        ...
        static void Rules()
        {
            string rules = " Целта на играта е да откриете избраното от противника (компютъра) число, с минимален брой въпроси. След всеки въпрос противникът(компютърът) съобщава броя на съвпаденията (брой бикове и брой крави)." +
                "\nВсички цифри на числото са различни. \n В тази имплементация на играта, цифрите(освен първата цифра на числото) могат да бъдат и нули. " +
                "\nКогато за дадено число бъде позната и неговата позиция, това е \"бик\"." +
                "Когато дадено число бъде познато, но не е на правилната позиция, това е \"крава\"." +
                "\nНапример: \nЧислото генерирано от компютъра е 3568, а предположението на играча е 3679.\nРезултатът е: 1 бик(числото 3, което е на вярната си позиция) и 1 крава (числото 6, което е познато, но е на грешна позиция.";
